          ...
          >
            ...
            <div className="flex items-center gap-2">
              <div className="text-5xl font-bold text-white overflow-hidden h-16 flex items-center">
                <div className="animate-slotMachine">{animatedElo}</div>
              </div>
            </div>
            ...
            {problem.isFrq ? (
              <div className="space-y-3">
                <input
                  ...
                  onChange={(e) =>
                    !firstSubmissionMade && onSelectAnswer(e.target.value)
                  }
              ...
              <>
                {problem.answerChoices &&
                  Object.keys(problem.answerChoices).map((option, index) => {
                    ...
                    const wasSubmitted =
                      selectedAnswer === option && firstSubmissionMade;
                    const showAsCorrect =
                      wasSubmitted && firstSubmissionCorrect;
                    ...
                    return (
                      <div key={option}>
                        <button
                          onClick={() =>
                            !firstSubmissionMade && onSelectAnswer(option)
                          }
                          disabled={firstSubmissionMade}
